...
cbox_rs_1 = ttk.Combobox(master=secondRowFrame,value=Resultvalue).grid(row=1,column=4,sticky=Tk.W).current(9)
cbox_rs_1.bind("<<ComboboxSelected>>",func1)
Tk.Label(master=secondRowFrame,text='Rad_m1').grid(row=1,column=5,sticky=Tk.W)
cbox_Rad_1 = ttk.Combobox(master=secondRowFrame,value=Rad).grid(row=1,column=6,sticky=Tk.W).current(9)
cbox_Rad_1.current(0)
Tk.Label(master=secondRowFrame,text='Eta_m1').grid(row=1,column=7,sticky=Tk.W)
cbox_Eta_1 = ttk.Combobox(master=secondRowFrame,value=Eta).grid(row=1,column=8,sticky=Tk.W).current(9)
cbox_Eta_1.current(0)
...
cbox_rs_2 = ttk.Combobox(master=thirdRowFrame,value=Resultvalue).grid(row=1,column=4,sticky=Tk.W).current(9)
Tk.Label(master=thirdRowFrame,text='Rad_m2').grid(row=1,column=5,sticky=Tk.W)
cbox_Rad_2 = ttk.Combobox(master=thirdRowFrame,value=Rad).grid(row=1,column=6,sticky=Tk.W).current(9)
cbox_Rad_2.current(0)
Tk.Label(master=thirdRowFrame,text='Eta_m2').grid(row=1,column=7,sticky=Tk.W)
cbox_Eta_2 = ttk.Combobox(master=thirdRowFrame,value=Eta).grid(row=1,column=8,sticky=Tk.W).current(9)
cbox_Eta_2.current(0)
