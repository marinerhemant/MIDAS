...
ln -s ${LOCAL_DIR}/runSingleLayer.sh ${configdir}/MIDAS_V4_NearFieldSingleLayer.sh
ln -s ${LOCAL_DIR}/runMultipleLayers.sh ${configdir}/MIDAS_V4_NearFieldMultipleLayers.sh
ln -s ${LOCAL_DIR}/runNFParameters.sh ${configdir}/MIDAS_V4_NearFieldParameters.sh
