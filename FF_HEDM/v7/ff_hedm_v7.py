...
startdir = os.getcwd()
print("Generating ZarrZip file. Time till now: "+time.time()-t0)
...
print("Generating HKLs. Time till now: "+time.time()-t0)
...
f_hkls.close()
print("Doing PeakSearch. Time till now: "+time.time()-t0)
...
f.close()
print("Merging peaks. Time till now: "+time.time()-t0)
...
f.close()
print("Calculating Radii. Time till now: "+time.time()-t0)
...
f.close()
print("Transforming data. Time till now: "+time.time()-t0)
...
f.close()
os.chdir(resultDir)
print("Binning data. Time till now: "+time.time()-t0)
...
print("Indexing. Time till now: "+time.time()-t0)
...
f.close()
print("Refining. Time till now: "+time.time()-t0)
...
f.close()
print("Making grains list. Time till now: "+time.time()-t0)
...
f.close()
print("Done. Total time elapsed: "+time.time()-t0)