...
if [ ! -d ${dirThis}/hdf5/include ]; then #HDF5
	cd ${dirThis}
	echo $(pwd)
	wget https://www.dropbox.com/s/bv4b36qhsilprzf/hdf5-1.8.13.tar.gz?dl=0 # https://dl.dropboxusercontent.com/u/19201865/hdf5-1.8.13.tar.gz -O hdf5-1.8.13.tar.gz
...
if [ ! -d ${dirThis}/curl/include ]; then #HDF5
	cd ${dirThis}
	echo $(pwd)
	wget https://www.dropbox.com/s/yu2tg26djnuuwqb/curl-7.49.1.tar.gz?dl=0 # https://dl.dropboxusercontent.com/u/19201865/curl-7.49.1.tar.gz -O curl-7.49.1.tar.gz
