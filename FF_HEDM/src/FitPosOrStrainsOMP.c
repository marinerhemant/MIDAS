...
int main(int argc, char *argv[])
{
	...
	for (thisRowNr = 0; thisRowNr < nSptIDs; thisRowNr++){
	    ...
	    printf("SpotID %-6d, %-6d out of %-6d, Errors: %7.2f %7.2f %7.2f, ",SpId,thisRowNr,nSptIDs,ErrorFin[0],ErrorFin[1],ErrorFin[2]);
	    for (i=0;i<nSpotsComp;i++) for (j=0;j<9;j++) spotsYZONew[i][j]=Splist[i][j];
	    printf("Fitvals: Pos: %7.2f %7.2f %7.2f, Orient: %7.2f %7.2f %7.2f, LatC: %7.2f %7.2f %7.2f %7.2f %7.2f %7.2f\n",
