...
#define EPS 1e-9
inline double sin_cos_to_angle(double s, double c) {
  return (s >= 0.0) ? acos(c) : 2.0 * M_PI - acos(c);
}
inline double cosd(double x) { return cos(deg2rad * x); }
inline double sind(double x) { return sin(deg2rad * x); }
...
double MonoSym[2][4] = {{1.00000, 0.00000, 0.00000, 0.00000},
                        {0.00000, 1.00000, 0.00000, 0.00000}};

double OrtSym[4][4] = {{1.00000, 0.00000, 0.00000, 0.00000},
                       {1.00000, 1.00000, 0.00000, 0.00000},
                       {0.00000, 0.00000, 1.00000, 0.00000},
                       {0.00000, 0.00000, 0.00000, 1.00000}};

double TetSym[8][4] = {{1.00000, 0.00000, 0.00000, 0.00000},
...
double TrigSym[6][4] = {{1.00000, 0.00000, 0.00000, 0.00000},
...
double HexSym[12][4] = {{1.00000, 0.00000, 0.00000, 0.00000},
...
double CubSym[24][4] = {{1.00000, 0.00000, 0.00000, 0.00000},
