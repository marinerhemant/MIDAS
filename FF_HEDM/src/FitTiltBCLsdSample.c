...
int main(int argc, char *argv[])
{
    ...
    double StepSizePos=5,StepSizeOrient=0.2,MarginRadius=200,MarginRadial=200,OmeBinSize=0.1,EtaBinSize=0.1,MarginEta=200,MarginOme=0.7;
