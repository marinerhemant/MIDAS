...
int main(int argc, char *argv[])
{
	...
	double tols[24] = {500,500,500,deg2rad*0.0005,deg2rad*0.0005,deg2rad*0.0005,1,1,1,1,1,1,
		3,0.0000001,3,0.0000001,0.0000001,0.0000001,0.0000001,0.0000001,0.0000001,0.0000001,0.0000001,0.0000001};	// 250 microns for position, 0.0005 degrees for orient, 1 % for latticeParameter,
