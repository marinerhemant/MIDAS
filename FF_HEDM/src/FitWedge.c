...
void YsZsCalc(double Lsd,double Ycen,double Zcen,double p0,double p1,double p2,
			  double MaxRad,double tx,double ty,double tz,double px,double Ys,
			  double Zs,double *YOut,double *ZOut){
	...
	void* f_data_trial)
{
	...
	double Option_1 = fabs((Sin_Omega1*Sin_Omega1) + (Cos_Omega1*Cos_Omega1) - 1);
	double Option_2 = fabs((Sin_Omega1*Sin_Omega1) + (Cos_Omega2*Cos_Omega2) - 1);
	...
	Error = OmegaMin;
	//printf("%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",Omega1,Omega_1,Omega_2,fabs(Omega1-Omega_1),fabs(Omega1-Omega_2),wedge,G1a,G2a,G3a,g1,g2,g3,Length_G,ds,normGa);
	//printf("%2.30f\n",Error);
	return Error;
}

void FitWedge(double Lsd,double Ycen,double Zcen,double p0,double p1,double p2,
			  double MaxRad,double tx,double ty,double tz,double px,double Ys,
			  double Zs,double MinOme,double MaxOme,double WedgeIn,double *WedgeFit,double Wavelength){
...
int main (int argc, char *argv[]){
	...
	Zs[1] = Z[Second];
	double WedgeFit;
	FitWedge(Lsd,Ycen,Zcen,p0,p1,p2,MaxRad,tx,ty,tz,px,Ys[0],Zs[0],MinOme,MaxOme,Wedge,&WedgeFit,Wavelength);
