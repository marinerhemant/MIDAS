...
parser.add_argument('-omegaFirstFile', type=str, required=True, help='Rotation angle for the first frame. If left handed rotation (eg. Aerotech), should be negative of real value')
...
omegaFirstFile = float(args.omegaFirstFile)
