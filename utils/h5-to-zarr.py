...
if __name__ == '__main__':
    ...
    fn = sys.argv[1]
    # fn = '/Users/hsharma/Desktop/analysis/startup_feb23/Ceria_900mm_100x100_0p5s_att_1_aero_0_000584.h5'
    outfn = '.'.join(fn.split('h5')[:-1])+'zarr'
