...
Tk.Checkbutton(master=secondRowFrame,text="MaxOverFrames",variable=getMaxVar).grid(row=1,column=12,sticky=Tk.W)
Tk.Label(master=secondRowFrame,text="nFramesMax").grid(row=1,column=13,sticky=Tk.W)
Tk.Entry(master=secondRowFrame,textvariable=nFramesMaxVar,width=5).grid(row=1,column=14)
Tk.Label(master=secondRowFrame,text="startFrameNrMax").grid(row=1,column=15,sticky=Tk.W)
Tk.Entry(master=secondRowFrame,textvariable=maxStartFrameNrVar,width=5).grid(row=1,column=16,sticky=Tk.W)
Tk.Label(master=secondRowFrame,text="BytesPerPx").grid(row=1,column=17,sticky=Tk.W)
Tk.Entry(master=secondRowFrame,textvariable=BytesVar,width=2).grid(row=1,column=18,sticky=Tk.W)
Tk.Label(master=secondRowFrame,text="HeadSize").grid(row=1,column=19,sticky=Tk.W)
