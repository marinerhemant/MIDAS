...
Tk.Label(master=secondRowFrame,text='firstFileNr').grid(row=1,column=9,sticky=Tk.W)
Tk.Label(master=secondRowFrame,text='nFramesPerFile').grid(row=1,column=11,sticky=Tk.W)
...
efirstfile.grid(row=1,column=10,sticky=Tk.W)
enFrames = Tk.Entry(master=secondRowFrame,textvariable=nFramesPerFileVar,width=5)
enFrames.grid(row=1,column=12,sticky=Tk.W)
